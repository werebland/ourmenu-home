  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(RequestDemo, [{
    ...
    value: function handleUpload(id) {
      ...
      files.forEach(function (file) {
        ...
        var uploadTask = storageRef.child("users/".concat(id, "/menus/")).put(file, metadata);
        ...
        function (snapshot) {
          ...
          uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
            ...
            if (downloadLinks.length === files.length) {
              ...
              _config__WEBPACK_IMPORTED_MODULE_13__["default"].update("");
            }
          });
        });
      });
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(PageWrapper, {
        ...
        __self: this
      }, this.state.isSuccess ? react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 317
        },
        __self: this
      }, "Success! Thanks, ", this.state.name, ". We'll be in touch at ", this.state.email, ".") : react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_7__["Fragment"], {
        __source: {
          fileName: _jsxFileName,
          lineNumber: 321
        },
...
//# sourceMappingURL=request-demo.js.3f346733a8a69b0c4929.hot-update.js.map